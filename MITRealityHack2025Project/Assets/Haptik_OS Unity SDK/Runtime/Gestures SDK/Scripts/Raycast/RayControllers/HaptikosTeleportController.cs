...
public class HaptikosTeleportController : HaptikosRayCastController
{
    Transform indexBase;
    Transform thumbBase;
    Transform wrist;
    ...
    protected override void Update()
    {
        ...
        if (raycast.Hover && raycast.SelectableHit)
        {
            raycast.colour = Color.green;
        }
        else
        {
            raycast.colour = Color.red;
        }
    }
}
